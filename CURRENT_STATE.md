...
黑石城门防守现在有独立的 `WARTIME_DEFENSE` 持久来源：它冻结真实城内编队，以 V5 schema 10 的显式来源与任务身份保存，不再把公告板“保护”任务冒充为可恢复防守。守城不重复扣出征粮，不改写普通主线压力；可在 C0 中确认临时工事，进入真实 `PROTECT_AND_ELIMINATE` 城门目标，并从 RESERVED/ACTIVE 守城快照恢复同一实例。敌军的位置已成为路线事实：沿两条路线推进、抵达城门后才伤害目标，V3 旧活动会话则保守升级为从路线起点重新推进。守城面板只提供瞭望台、箭塔和拒马，权威计划提交同样拒绝攻城槌；拒马完工后会分担城门承受的真实敌军伤害、消耗自身耐久并经正式按钮进入可保存维修。当前已验证来源建立、C0 施工入口、城门目标、敌军路线推进、守城专属工事限制、受损/维修冷恢复及撤离回写；完整胜利／失守结局和守军部署仍在继续实现，不能将此检查点称为完整守城。
