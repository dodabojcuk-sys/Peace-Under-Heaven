...
- 当前仅形成“伐木场／木材扩张”推荐与“农田／粮食供给”备选，尚未获得用户方向确认。
- P1-01 至 P1-04 尚未授权实施；运行时代码继续停留在已封存的 P0-06 基线。

## P1-00 研究状态

- 执行门禁：`docs/process/PROJECT_EXECUTION_GATES.md`。
- 首城闭环研究：`docs/design/P1_00_FIRST_CITY_GAMEPLAY_LOOP_RESEARCH.md`。
- 推荐方向：伐木场接入道路后产生木材，木材支持下一段道路或下一座伐木场。
- 可接受备选：农田接入道路后产生粮食／供给，继续扩展城市供给。
- 两个方向都只是研究候选，不得写成已获用户确认或已经实现。
- 用户当前唯一需要决定的问题是选择推荐闭环或备选闭环。
