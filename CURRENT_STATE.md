...
新增隔离图形 smoke 以正式黑石城入口进入守城 C0，使用可见路线、工事确认及城门维修按钮，记录计划、施工、受损、维修中与完成五个根视口截图。证据位于 `docs/milestones/field-tactics-r2/evidence/20260912-wartime-defense-gate-repair/`：维修前城门为 `9730/10000`，两战斗刻后为 `9850/10000`，截图与断言均确认不提前恢复。它使用引擎 GUI 按钮信号和显式的测试战斗刻加速，不冒充原生 macOS 鼠标或完整守城玩家验收；玩家验收保持 **OPEN**。
