...
- 大增量按顺序跨越各日界线；第 12 日不会自动停止或改变暂停状态，并能继续进入第 13 日及以后。
- 第 12 日仍是当前最后一个已定义特殊事件日；此后的通用维护、生产和研究继续结算，但不会重复第 12 日事件，也没有虚构新的特殊事件。
...
- 普通面板与焦点不自动暂停；
- 不同 delta 分片结果一致；
- 大增量和第 5／8／10／12／13 日边界；
- 第 12 日不自动暂停、当天进度继续积累、手动暂停恢复及第 12 日事件不重复；
- 无玩家 `EndDayButton`；
