...
@export var initial_medical_workers := 4
@export var initial_governance_workers := 4
...
func is_valid() -> bool:
	return (
		...
		and initial_medical_workers >= 0
		and initial_governance_workers >= 0
		and initial_production_workers + initial_construction_workers + initial_medical_workers + initial_governance_workers <= initial_living_population
