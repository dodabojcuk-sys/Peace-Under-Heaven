...
func initialize_from_theater(theater_points: Dictionary, theater_routes: Dictionary = {}, theater_water_regions: Array[Rect2i] = []) -> void:
	field_tactics.initialize_from_theater(theater_points, theater_routes, theater_water_regions)
