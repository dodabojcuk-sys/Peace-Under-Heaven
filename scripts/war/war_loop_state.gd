...
func initialize_from_theater(theater_points: Dictionary, theater_routes: Dictionary = {}, theater_water_regions: Array[Rect2i] = [], theater_world_bounds: Rect2i = Rect2i(-260, -180, 1520, 1040)) -> void:
	field_tactics.initialize_from_theater(theater_points, theater_routes, theater_water_regions, theater_world_bounds)
